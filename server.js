...
class Gun {
    constructor(body, info) {
        ...
        if (info.PROPERTIES != null && info.PROPERTIES.TYPE != null) {
            ...
            this.killmaster = (info.PROPERTIES.KILLMASTER == null) ?
                false : info.PROPERTIES.KILLMASTER;
        }                    
...
if (!needsRoom) { 
    socket.talk(
        ...
        roomSpeed
          ...
          body.sendMessage('Welcome to the game, left click or right click to shoot, press E to auto shoot, and press N to level up.');
                 //   body.sendMessage('You remain invulnerable until you move or shoot.');
                  body.sendMessage('Use arrow keys or W A S D to move')
    ...
    let spawnBosses = (() => {
        ...
        let boss = (() => {
            let i = 0,
                ...
                bois = [Class.egg],
                n = 0,
                begin = 'Somethings Wrong',
                arrival = 'Something happened tell CancelX',
                loc = 'norm';
            let spawn = () => {
                let spot, m = 0;
                do {
        ...
        return census => {
            if (timer > 6000 && ran.dice(16000 - timer)) {
                ...
                timer = 0;
                let choice = [];
                switch (ran.chooseChance(50, 40, 30, 20, 10)) {
                    case 0: 
                        choice = [[Class.elite_destroyer], 1, 'a', 'norm'];
                        break
                    case 1: 
                        choice = [[Class.elite_gunner], 1, 'a', 'norm']; 
                        break;
                     case 2: 
                    ...
                    case 3: 
                        ...
                        break;
                    case 4: 
                        choice = [[Class.necro_bonzi], 1, 'ultimate', 'nest']; 
          ...
          // Spawning
            ...
            spawnBosses(census);
               ...
               o.color = 17;
                  //o.color = 0;
                o.define(Class.bot);
                o.define(Class.builder);
                o.name += ran.chooseBotName();
                o.refreshBodyAttributes();
                o.color = 17;
                bots.push(o);
          }
                      if (bots.length < c.SENTINELS) {
                let o = new Entity(room.random());
              o.color = 13;
                        o.team = -100;
                  //o.color = 0;
                o.define(Class.sentinel_ai);
                o.define(Class.sentinelDrone);
                o.name += ran.chooseBotName();
                o.refreshBodyAttributes();
